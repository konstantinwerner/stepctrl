...
#define CS_LOW()  GPIOSetBitValue(CFG_CSPORT, CFG_CSPIN, 0);
#define CS_HIGH() GPIOSetBitValue(CFG_CSPORT, CFG_CSPIN, 1);
...
)
{
	...
	GPIOSetDir( CFG_CSPORT, CFG_CSPIN, 1 ); /* CS, Output */
#ifdef STA_ENABLE_DETECT
	GPIOSetDir( CFG_SDCARD_CDPORT, CFG_SDCARD_CDPIN, 0 ); /* Card Detect, Input */
#endif
